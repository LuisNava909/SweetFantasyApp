...
class AddProductActivity : BaseActivity(), View.OnClickListener {
    ...
    fun imageUploadSuccess(imageURL: String) {
        ...
        //showErrorSnackBar("Imagen subida. El URL es $imageURL", false)
    }

    private fun uploadProductDetails() {
        // Get the logged in username from the SharedPreferences that we have stored at a time of login.
        val username =
                this.getSharedPreferences(Constants.SWEETFANTASY_PREFERENCES, Context.MODE_PRIVATE)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (resultCode == Activity.RESULT_OK
            ...
            try {
                // Load the product image in the ImageView. TODO loadUserPicture por loadProductPicture
